...
/* 	var el = document.querySelectorAll("input[name='type']:checked");
	for (e of el) {
		console.log(e);
	} */
	var type = document.querySelectorAll("input[name='type']:checked").value;
    /* location.href = "login09.jsp?type=" + type + "}&accessToken=" + accessToken"; */
    
    console.log( "login09.jsp?type=" + type + "&accessToken=" + accessToken);
}
...
window.fbAsyncInit = function() {
  ...
  FB.init({
    appId      : '1111315139026447', // 개발자가 등록한 앱 ID
    cookie     : true,  
    xfbml      : true,  
    version    : 'v3.2' 
  });
