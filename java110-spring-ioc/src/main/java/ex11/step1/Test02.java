...
public class Test02 {
    ...
    //  key를 대소문자 구분하지 않게 하고 싶다
    //  => get(), put() 호출 전에 대소문자를 구분하지 않는 코드를 삽입하라!
    public static void test2() {
        Map<String, Object> map = new HashMap<String, Object>();
        
        map.put("name".toLowerCase(), "JEJE");
        map.put("Name".toLowerCase(), "EKEK");
        map.put("naMe".toLowerCase(), "MJMJ");
    ...
    //  key에 대해 대소문자를 구분하지 않게 Map을 만드는 두번째 방법:
    //  => 기존 맵을 상속 받아 기능을 변경하는것.
    public static void test3() {
        //  기존의 Map 소스를 변경할 수 없기 때문에,
        //  => 기존 클래스를 상속 받아 기능을 변경godi gksek.
        
        class MyHashMap extends HashMap<String, Object>{
            //  get()과 put()의 기능을 재정의 한다.(Overriding)
