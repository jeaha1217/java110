/*	객체생성 : 객체의 ID와 별명
    ...
    3) 객체의 아이디나 별명을 지정하지 않기
        - 번호가 붙은 클래스의 이름(패키지명을 포함한)이 객체의 이름으로 사용된다.
            예) ex03.Car#0
        - 만약 그 타입의 첫 번째 익명 객체라면 클래스 이름(패키지 명 포함)이 별명으로 설정된다.
            예) ex03.Car
...
public class Test02 {
    ...
    public static void main(String[] args) {
        ...
        ApplicationContext iocContainer = new ClassPathXmlApplicationContext("ex03/app-context-2.xml");
