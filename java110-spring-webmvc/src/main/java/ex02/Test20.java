...
public class Test20 {
    ...
    /*  
       ...
       주의!
           FrontController가 Multipart data를 처리 하려면,
           
       방법1)
           DD file에 Front Controller를 선언할때 다음의 tag를 설정한다.
       ...
       방법2)
        ...
        => multipartResolver 라는 이름으로 다음과 같이 객체를 등록한다.
            - 이 방식은 꼭! Apache common-fileupload 의존 라이브러리를 추가해야한다.
        => XML 설정 :
    ...
    */
    ...
    @Autowired
    ServletContext sc;
    //  Spring과 java에서 나오는 태그가 겹치는게 있다면 자바 태그를 스길 권장함.
