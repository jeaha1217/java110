...
public class Test12 {
    ...
    //  
    //  test:
    //  http://localhost:8888/app/ex02/test12/m1
    //  http://localhost:8888/app/ex02/test12/m2
    //  http://localhost:8888/app/ex02/test12/m3
    //  http://localhost:8888/app/ex02/test12/m4
    //? : http://localhost:8888/app/ex02/test12/m5
    //  http://localhost:8888/app/ex02/test12/m6
    ...
    public String m6(Map<String, Object> map) {
        ...
        //  Map 객체에 저장한 데이터는
        //  프론트 컨트롤러가 ServletRequest 보관소에 저장한다.
        
        return "/ex02/Test12.jsp";
    }
    
    //  JSP에 넘겨줄 데이터를 담을 수 있는 보관소 Model을 받을수 있다.
    @RequestMapping("m7")
